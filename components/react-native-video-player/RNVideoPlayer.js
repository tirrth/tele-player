...
export default class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.events = {
      ...
      onDownload: this._onDownload.bind(this),
    };
  ...
  /**
   * Render download button and set icon.
   */
  renderDownload() {
    let source = require('./assets/img/download-icon.png');

    return this.renderControl(
      <Image source={source} style={{height: 20, width: 20, marginLeft: 6}} />,
      this.events.onDownload,
      styles.controls.download,
    );
  }
